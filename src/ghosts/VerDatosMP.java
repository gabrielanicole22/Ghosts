 ...
 */
public class VerDatosMP extends javax.swing.JFrame {
    ...
    public VerDatosMP(SistemaUsuarios sistemaUsuarios, MenuInicio ventanaPrincipal) {
        initComponents();
    ...
    public void cargarPartidas() {
        ...
        for (int i = (partidas.toArray().length - 1); i >= 0; i--) {
            ...
            if (partida.puntosGanados == 1.5) {
                ...
                resultado = (partida.victoria) ? "VICTORIOSA" : "DERROTADA";
            }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 270, 586, 300));

        jLabel5.setFont(new java.awt.Font("Segoe Script", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(204, 255, 204));
        jLabel5.setText("* * * Mis logs * * *");
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 30, -1, -1));
